...
INPUT_FILE = "experiment_data_llama.json"
OUTPUT_PNG = "Figure_1_Llama70B_Manifold.png"
OUTPUT_PDF = "Figure_1_Llama70B_Manifold.pdf"

def plot_manifold():
    print(">>> 绘制 Llama-3.3-70B 流形轨迹图...")
    ...
    ax.set_title("Manifold Geometry of Llama-3.3-70B-Instruct Reasoning")
    ax.legend(loc="upper right")

    ax.text(0.02, 0.98, f"Model: Llama-3.3-70B-Instruct-INT8\nLayers: {num_layers}\nTopics: {len(data)}",
